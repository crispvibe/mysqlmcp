...
func main() {
	...
	if !ReadOnly {
		s.AddTool(createDatabaseTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			result, err := HandleCreateDatabase(name, OptionalStringArg(request, "charset"), OptionalStringArg(request, "collation"))
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
	...
	s.AddTool(listTableTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		result, err := HandleListTables(database)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	if !ReadOnly {
		...
		s.AddTool(createIndexTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			result, err := HandleCreateIndex(name, table, columns, OptionalStringArg(request, "database"), OptionalBoolArg(request, "unique"))
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
		...
		s.AddTool(dropIndexTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			name, err := RequiredStringArg(request, "name")
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
			...
			result, err := HandleDropIndex(name, table, OptionalStringArg(request, "database"))
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
		...
		s.AddTool(dropDatabaseTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			name, err := RequiredStringArg(request, "name")
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}

			result, err := HandleDropDatabase(name, OptionalBoolArg(request, "if_exists"))
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
		...
		s.AddTool(dropTableTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			name, err := RequiredStringArg(request, "name")
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}

			result, err := HandleDropTable(name, OptionalStringArg(request, "database"), OptionalBoolArg(request, "if_exists"))
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
		...
		s.AddTool(truncateTableTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			name, err := RequiredStringArg(request, "name")
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}

			result, err := HandleTruncateTable(name, OptionalStringArg(request, "database"))
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
		...
		s.AddTool(executeDDLTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			query, err := RequiredStringArg(request, "query")
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
		...
		s.AddTool(executeMigrationTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			query, err := RequiredStringArg(request, "query")
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
	...
	s.AddTool(showCreateTableTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		name, err := RequiredStringArg(request, "name")
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
		...
		database := OptionalStringArg(request, "database")
		result, err := HandleShowCreateTable(name, database)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(showColumnsTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		name, err := RequiredStringArg(request, "name")
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
		...
		database := OptionalStringArg(request, "database")
		result, err := HandleShowColumns(name, database)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(showIndexTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		name, err := RequiredStringArg(request, "name")
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
		...
		database := OptionalStringArg(request, "database")
		result, err := HandleShowIndex(name, database)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(showConstraintsTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		database := OptionalStringArg(request, "database")
		name := OptionalStringArg(request, "name")
		result, err := HandleShowConstraints(name, database)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(showTableStatusTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		database := OptionalStringArg(request, "database")
		name := OptionalStringArg(request, "name")
		result, err := HandleShowTableStatus(name, database)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(showProcesslistTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	if !ReadOnly {
		s.AddTool(killQueryTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			result, err := HandleKillQuery(pid)
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
	...
	s.AddTool(showVariablesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		pattern := OptionalStringArg(request, "pattern")
		result, err := HandleShowVariables(pattern)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(showStatusTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		pattern := OptionalStringArg(request, "pattern")
		result, err := HandleShowStatus(pattern)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(explainTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		result, err := HandleQuery(fmt.Sprintf("EXPLAIN %s", query), StatementTypeNoExplainCheck)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(beginTransactionTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	s.AddTool(transactionReadQueryTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		result, err := HandleTransactionQuery(txID, query)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	if !ReadOnly {
		s.AddTool(transactionExecQueryTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			txID, err := RequiredStringArg(request, "tx_id")
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
			...
			result, err := HandleTransactionExec(txID, query)
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
	...
	s.AddTool(commitTransactionTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		txID, err := RequiredStringArg(request, "tx_id")
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(rollbackTransactionTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		txID, err := RequiredStringArg(request, "tx_id")
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
	...
	s.AddTool(readQueryTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		result, err := HandleQueryWithLimit(query, StatementTypeSelect, readQueryMaxRows)
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
...
func HandleQuery(query, expect string, args ...interface{}) (string, error) {
	return HandleQueryWithLimit(query, expect, 0, args...)
}

// HandleQueryWithLimit 同 HandleQuery 但限制返回行数，maxRows=0 表示不限。
func HandleQueryWithLimit(query, expect string, maxRows int, args ...interface{}) (string, error) {
	result, headers, truncated, err := DoQuery(query, expect, maxRows, args...)
	if err != nil {
		return "", err
	}
...
func DoQuery(query, expect string, maxRows int, args ...interface{}) ([]map[string]interface{}, []string, bool, error) {
	db, err := GetDB()
	if err != nil {
	...
	return DoQueryWithExecutor(db, query, maxRows, args...)
}

func DoQueryWithExecutor(q queryer, query string, maxRows int, args ...interface{}) ([]map[string]interface{}, []string, bool, error) {
...
func HandleListTables(database string) (string, error) {
	query := "SHOW TABLES"
	if strings.TrimSpace(database) != "" {
		query = fmt.Sprintf("SHOW TABLES FROM %s", QuoteIdentifier(database))
	}

	return HandleQuery(query, StatementTypeNoExplainCheck)
}

func HandleShowCreateTable(name, database string) (string, error) {
	db, err := GetDB()
	if err != nil {
		return "", err
	}
	...
	rows, err := db.Queryx(fmt.Sprintf("SHOW CREATE TABLE %s", tableName))
	if err != nil {
		return "", err
	}
	defer rows.Close()
...
func HandleShowColumns(name, database string) (string, error) {
	tableName, err := QualifiedTableName(name, database)
	if err != nil {
		return "", err
	}

	return HandleQuery(fmt.Sprintf("SHOW FULL COLUMNS FROM %s", tableName), StatementTypeNoExplainCheck)
}

func HandleShowIndex(name, database string) (string, error) {
	tableName, err := QualifiedTableName(name, database)
	if err != nil {
		return "", err
	}

	return HandleQuery(fmt.Sprintf("SHOW INDEX FROM %s", tableName), StatementTypeNoExplainCheck)
}

func HandleShowConstraints(name, database string) (string, error) {
	query := `
SELECT
...
WHERE tc.CONSTRAINT_SCHEMA = COALESCE(NULLIF(?, ''), DATABASE())`
	...
	return HandleQuery(query, StatementTypeNoExplainCheck, args...)
}

func HandleShowTableStatus(name, database string) (string, error) {
...
func HandleShowProcesslist() (string, error) {
	return HandleQuery("SHOW FULL PROCESSLIST", StatementTypeNoExplainCheck)
}

func HandleKillQuery(processID int) (string, error) {
	if processID <= 0 {
		return "", fmt.Errorf("process_id must be a positive integer")
	}
	return HandleExec(fmt.Sprintf("KILL %d", processID), StatementTypeNoExplainCheck)
}

func HandleShowVariables(pattern string) (string, error) {
...
func HandleShowStatus(pattern string) (string, error) {
	query := "SHOW STATUS"
	if strings.TrimSpace(pattern) != "" {
		query += fmt.Sprintf(" LIKE %s", QuoteStringLiteral(strings.TrimSpace(pattern)))
	}
...
func HandleCreateDatabase(name, charset, collation string) (string, error) {
	...
	return HandleExec(strings.Join(parts, " "), StatementTypeNoExplainCheck)
}

func HandleCreateIndex(name, table, columns, database string, unique bool) (string, error) {
	...
	return HandleExec(query, StatementTypeNoExplainCheck)
}

func HandleDropIndex(name, table, database string) (string, error) {
	tableName, err := QualifiedTableName(table, database)
	if err != nil {
		return "", err
	}

	return HandleExec(fmt.Sprintf("DROP INDEX %s ON %s", QuoteIdentifier(name), tableName), StatementTypeNoExplainCheck)
}

func HandleDropDatabase(name string, ifExists bool) (string, error) {
	if strings.TrimSpace(name) == "" {
...
func HandleDropTable(name, database string, ifExists bool) (string, error) {
	tableName, err := QualifiedTableName(name, database)
	if err != nil {
		return "", err
	}
...
func HandleTruncateTable(name, database string) (string, error) {
	tableName, err := QualifiedTableName(name, database)
	if err != nil {
		return "", err
	}
	return HandleExec(fmt.Sprintf("TRUNCATE TABLE %s", tableName), StatementTypeNoExplainCheck)
}
...
func HandleExecuteMigration(ctx context.Context, query string, useTransaction bool) (string, error) {
	...
	if useTransaction {
		...
		for i, statement := range statements {
			result, err := ExecuteStatement(tx, statement)
			if err != nil {
...
func ExecuteStatement(e execer, statement string) (string, error) {
	result, err := e.Exec(statement)
	if err != nil {
		return "", err
	}
...
func HandleTransactionQuery(txID, query string) (string, error) {
	...
	result, headers, _, err := DoQueryWithExecutor(mt.Tx, query, 0)
	if err != nil {
		return "", err
	}
...
func HandleTransactionExec(txID, query string) (string, error) {
