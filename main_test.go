...
func TestHandleQuery(t *testing.T) {
	...
	t.Run("successful query", func(t *testing.T) {
		...
		// Call HandleQuery
		result, err := HandleQuery(context.Background(), "SELECT id, name FROM users", StatementTypeNoExplainCheck)
	...
	t.Run("query error", func(t *testing.T) {
		...
		// Call HandleQuery
		_, err := HandleQuery(context.Background(), "SELECT id, name FROM users", StatementTypeNoExplainCheck)
...
func TestDoQuery(t *testing.T) {
	...
	t.Run("successful query", func(t *testing.T) {
		...
		// Call DoQuery
		result, headers, _, err := DoQuery(context.Background(), "SELECT id, name FROM users", StatementTypeNoExplainCheck, 0)
	...
	t.Run("with explain check", func(t *testing.T) {
		...
		// Call DoQuery
		result, headers, _, err := DoQuery(context.Background(), "SELECT id, name FROM users", StatementTypeSelect, 0)
	...
	t.Run("query error", func(t *testing.T) {
		...
		// Call DoQuery
		_, _, _, err := DoQuery(context.Background(), "SELECT id, name FROM users", StatementTypeNoExplainCheck, 0)
	...
	t.Run("with byte array conversion", func(t *testing.T) {
		...
		// Call DoQuery
		result, headers, _, err := DoQuery(context.Background(), "SELECT id, blob FROM users", StatementTypeNoExplainCheck, 0)
	...
	t.Run("maxRows truncation", func(t *testing.T) {
		...
		result, _, truncated, err := DoQuery(context.Background(), "SELECT id, name FROM users", StatementTypeNoExplainCheck, 2)
		assert.NoError(t, err)
		assert.Len(t, result, 2)
		assert.Equal(t, int64(1), result[0]["id"])
		assert.Equal(t, int64(2), result[1]["id"])
...
func TestHandleQueryWithLimitTruncationWarning(t *testing.T) {
	...
	result, err := HandleQueryWithLimit(context.Background(), "SELECT id, name FROM users", StatementTypeNoExplainCheck, 2)
	assert.NoError(t, err)
...
func TestHandleExec(t *testing.T) {
	...
	t.Run("insert statement", func(t *testing.T) {
		...
		// Call HandleExec
		result, err := HandleExec(context.Background(), "INSERT INTO users (name) VALUES ('test')", StatementTypeInsert)
	...
	t.Run("update statement", func(t *testing.T) {
		...
		// Call HandleExec
		result, err := HandleExec(context.Background(), "UPDATE users SET name = 'updated' WHERE id IN (1, 2)", StatementTypeNoExplainCheck)
	...
	t.Run("exec error", func(t *testing.T) {
		...
		// Call HandleExec
		_, err := HandleExec(context.Background(), "UPDATE users SET name = 'updated'", StatementTypeNoExplainCheck)
...
func TestHandleExplain(t *testing.T) {
	...
	t.Run("with explain check disabled", func(t *testing.T) {
		...
		err := HandleExplain(context.Background(), "SELECT * FROM users", StatementTypeSelect)
	...
	t.Run("insert query", func(t *testing.T) {
		...
		// Call HandleExplain
		err := HandleExplain(context.Background(), "INSERT INTO users (name) VALUES ('test')", StatementTypeInsert)
	...
	t.Run("update query", func(t *testing.T) {
		...
		// Call HandleExplain
		err := HandleExplain(context.Background(), "UPDATE users SET name = 'test' WHERE id = 1", StatementTypeUpdate)
	...
	t.Run("delete query", func(t *testing.T) {
		...
		// Call HandleExplain
		err := HandleExplain(context.Background(), "DELETE FROM users WHERE id = 1", StatementTypeDelete)
	...
	t.Run("type mismatch", func(t *testing.T) {
		...
		// Call HandleExplain
		err := HandleExplain(context.Background(), "INSERT INTO users (name) VALUES ('test')", StatementTypeUpdate)
...
func TestHandleShowCreateTable(t *testing.T) {
	...
	t.Run("successful desc", func(t *testing.T) {
		...
		result, err := HandleShowCreateTable(context.Background(), "users", "")
	...
	t.Run("table not found", func(t *testing.T) {
		...
		// Call HandleShowCreateTable
		_, err := HandleShowCreateTable(context.Background(), "nonexistent", "")
	...
	t.Run("query error", func(t *testing.T) {
		...
		// Call HandleShowCreateTable
		_, err := HandleShowCreateTable(context.Background(), "users", "")
...
func TestHandleListTablesWithDatabase(t *testing.T) {
	...
	result, err := HandleListTables(context.Background(), "app")
	assert.NoError(t, err)
...
func TestHandleShowCreateTableWithDatabase(t *testing.T) {
	...
	result, err := HandleShowCreateTable(context.Background(), "users", "app")
	assert.NoError(t, err)
	assert.Contains(t, result, "CREATE TABLE `users`")
	assert.NoError(t, mock.ExpectationsWereMet())
}
...
func TestHandleShowIndex(t *testing.T) {
	...
	result, err := HandleShowIndex(context.Background(), "users", "app")
	assert.NoError(t, err)
...
func TestHandleShowConstraints(t *testing.T) {
	...
	result, err := HandleShowConstraints(context.Background(), "users", "app")
	assert.NoError(t, err)
...
func TestHandleShowTableStatus(t *testing.T) {
	...
	t.Run("with database and name pattern", func(t *testing.T) {
		...
		result, err := HandleShowTableStatus(context.Background(), "user%", "app")
		assert.NoError(t, err)
	...
	t.Run("without database or name", func(t *testing.T) {
		...
		result, err := HandleShowTableStatus(context.Background(), "", "")
		assert.NoError(t, err)
		assert.Contains(t, result, "InnoDB")
		assert.NoError(t, mock.ExpectationsWereMet())
	})
...
func TestHandleShowProcesslist(t *testing.T) {
	...
	result, err := HandleShowProcesslist(context.Background())
	assert.NoError(t, err)
...
func TestHandleKillQuery(t *testing.T) {
	...
	t.Run("valid process id", func(t *testing.T) {
		...
		result, err := HandleKillQuery(context.Background(), 42)
		assert.NoError(t, err)
	...
	t.Run("invalid process id", func(t *testing.T) {
		_, err := HandleKillQuery(context.Background(), -1)
		assert.Error(t, err)
		assert.Contains(t, err.Error(), "positive integer")
	})

	t.Run("zero process id", func(t *testing.T) {
		_, err := HandleKillQuery(context.Background(), 0)
		assert.Error(t, err)
		assert.Contains(t, err.Error(), "positive integer")
	})
}
...
func TestHandleShowVariables(t *testing.T) {
	...
	t.Run("with pattern", func(t *testing.T) {
		...
		result, err := HandleShowVariables(context.Background(), "max_%")
		assert.NoError(t, err)
	...
	t.Run("without pattern", func(t *testing.T) {
		...
		_, err := HandleShowVariables(context.Background(), "")
		assert.NoError(t, err)
		assert.NoError(t, mock.ExpectationsWereMet())
	})
}
...
func TestHandleShowStatus(t *testing.T) {
	...
	t.Run("with pattern", func(t *testing.T) {
		...
		mock.ExpectQuery("SHOW STATUS LIKE").WillReturnRows(rows)
		result, err := HandleShowStatus(context.Background(), "Threads_%")
		assert.NoError(t, err)
	...
	t.Run("without pattern", func(t *testing.T) {
		...
		_, err := HandleShowStatus(context.Background(), "")
		assert.NoError(t, err)
		assert.NoError(t, mock.ExpectationsWereMet())
	})
}
...
func TestTransactionLifecycle(t *testing.T) {
	...
	execResult, err := HandleTransactionExec(context.Background(), txID, "UPDATE users SET name = 'a' WHERE id = 1")
	assert.NoError(t, err)
...
func TestTransactionExecRejectsImplicitCommit(t *testing.T) {
	...
	_, err := HandleTransactionExec(context.Background(), "missing", "ALTER TABLE users ADD COLUMN age int")
	assert.Error(t, err)
...
func TestDevelopmentDDLHandlers(t *testing.T) {
	...
	result, err := HandleCreateDatabase(context.Background(), "app", "utf8mb4", "utf8mb4_0900_ai_ci")
	assert.NoError(t, err)
	...
	result, err = HandleCreateIndex(context.Background(), "uk_users_email", "users", "email, tenant_id", "app", true)
	assert.NoError(t, err)
	assert.Equal(t, "0 rows affected", result)

	mock.ExpectExec(regexp.QuoteMeta("DROP INDEX `uk_users_email` ON `app`.`users`")).
		WillReturnResult(sqlmock.NewResult(0, 0))
	result, err = HandleDropIndex(context.Background(), "uk_users_email", "users", "app")
	assert.NoError(t, err)
	assert.Equal(t, "0 rows affected", result)
